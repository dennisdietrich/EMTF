            ...
            switch (scenario)
            {
                case BaseScenario.AllScenariosNonConcurrentRun:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.AllScenariosNonConcurrentRun.baseline"),
                ...
                case BaseScenario.CloseLogger:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.CloseLogger.baseline"),
                                         testRunEventArgs.Total,
                                         testRunEventArgs.StartTime,
                                         Environment.MachineName,
                                         testEventArgs[0].StartTime);
                case BaseScenario.EmptyTestRun:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.EmptyTestRun.baseline"),
                                         testRunEventArgs.Total,
                                         testRunEventArgs.StartTime,
                                         Environment.MachineName);
                case BaseScenario.FullTestNameTestRun:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.FullTestNameTestRun.baseline"),
                                         testRunEventArgs.Total,
                                         testRunEventArgs.StartTime,
                                         Environment.MachineName,
                                         testEventArgs[0].StartTime,
                ...
                case BaseScenario.SinglePassingTestConcurrentRun:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.SinglePassingTestConcurrentRun.baseline"),
                                         testRunEventArgs.Total,
                                         testRunEventArgs.StartTime,
                                         Environment.MachineName,
                                         testEventArgs[0].StartTime,
                ...
                case BaseScenario.SingleSkippedTestConcurrentRun:
                    return String.Format(CultureInfo.CurrentCulture,
                                         GetBaseline("LoggerTests.StreamLogger.SingleSkippedTestConcurrentRun.baseline"),
                                         testRunEventArgs.Total,
                                         testRunEventArgs.StartTime,
                                         Environment.MachineName,
                                         testRunCompletedEventArgs.Total,
