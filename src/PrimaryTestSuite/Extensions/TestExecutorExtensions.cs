...
namespace PrimaryTestSuite.Extensions
{
    public static class TestExecutorExtensions
    {
        ...
        public static EventHandler GetTestRunStarted(this EmtfTestExecutor executor)
        {
            if (executor == null)
                throw new ArgumentNullException("executor");

            return (EventHandler)_testRunStartedFieldInfo.GetValue(executor);
        }

        public static void SetTestRunStarted(this EmtfTestExecutor executor, EventHandler handler)
        {
            if (executor == null)
                throw new ArgumentNullException("executor");
        ...
        public static EventHandler GetTestRunCompleted(this EmtfTestExecutor executor)
        {
            if (executor == null)
                throw new ArgumentNullException("executor");

            return (EventHandler)_testRunCompletedFieldInfo.GetValue(executor);
        }

        public static void SetTestRunCompleted(this EmtfTestExecutor executor, EventHandler handler)
        {
            if (executor == null)
                throw new ArgumentNullException("executor");
        ...
        public static void ExecuteImpl(this EmtfTestExecutor executor, IEnumerable<MethodInfo> testMethods)
        {
            if (executor == null)
                throw new ArgumentNullException("executor");

            _executeImplMethodInfo.Invoke(executor, new object[] { testMethods });
        }
