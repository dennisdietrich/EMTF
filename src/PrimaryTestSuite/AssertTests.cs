...
namespace PrimaryTestSuite
{
    ...
    public class AssertTests
    {
        ...
        [TestMethod]
        [Description("Tests the properties of the Assert class")]
        public void Properties()
        {
            EmtfAssert.BreakOnAssertFailure = false;
            Assert.IsFalse(EmtfAssert.BreakOnAssertFailure);

            EmtfAssert.BreakOnAssertFailure = true;
            Assert.IsTrue(EmtfAssert.BreakOnAssertFailure);
